...
| 字段 | 类型 | 说明 |
|------|------|------|
| out_trade_no | VARCHAR(64) | 商户订单号，格式：NS + 时间戳 + borrowId + 随机数 |
| trade_no | VARCHAR(64) | 支付宝返回的交易号 |
| payment_type | VARCHAR(20) | RENT(租金) / DEPOSIT(押金) / RENT_AND_DEPOSIT(租金+押金) |
| rent_amount | DECIMAL(10,2) | 租金 = 日租金 × 借阅天数 |
| deposit_amount | DECIMAL(10,2) | 押金，从物品表获取 |
